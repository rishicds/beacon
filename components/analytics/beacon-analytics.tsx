...
import { Eye, Users, Globe, AlertTriangle, TrendingUp, Clock } from "lucide-react"
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">After sending</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Flagged opens</p>
        </CardContent>
      </Card>
    </div>
  )
